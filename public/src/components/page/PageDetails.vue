        ...
        >
          ...
          <v-card-text class="grow py-0">
            <v-list avatar>
              ...
              <v-divider />
              <div
                class="py-3 text-break subheading font-weight-regular"
              >
      ...
      >
        <v-card>
          <v-toolbar color="primary">
            ...
            >
              {{ $t('your') }} {{ $t('_message') }} {{ $t('to') }} {{ contactName }}
            </v-card-title>
          </v-toolbar>
...
export default {
  ...
  created: async function () {
    if (!this.$route.params.page_name) { return this.$router.push({ name: 'home' }) }
