  ...
  <div fluild grid-list-xs class="v-list__container pa-0">
            ...
            >
              <v-layout row wrap d-flex class="v-list__tile px-0 mx-0">
                ...
                <v-flex class="v-list__tile__content xs2 sm2 md2 px-0 mx-0">
                  <v-list-tile-title>{{
                    p.Description | shorten(10)
                  }}</v-list-tile-title>
                </v-flex>

                <v-flex
                  class="xs8 sm8 md8 px-0 d-flex v-list__tile__action text-xs-right"
                >
                  <v-checkbox
                    v-model="isPublic[idx]"
                    :class="{
                      'v-btn v-btn--small v-btn--flat v-btn--floating':
    ...
    <v-layout>
      <v-flex d-flex>
        ...
        >
          <template slot="open-btn">
            <v-btn block color="success" flat>
              {{ $t('new') }} {{ $t('page') }}
            </v-btn>
          </template>
